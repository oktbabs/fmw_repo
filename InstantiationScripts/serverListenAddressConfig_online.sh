#+++++++++++++++++++++++++++++++++++++++++++++++++++++
# Script Name  : serverListenAddressConfig_online.sh +
...
java weblogic.WLST -loadProperties /tmp/appCSVFolder/inputAppProperties.csv  serverListenAddressConfig_online.py $1
